...
- Repo: `<ORG>/<PATH-REVIEW-REPO>` <!-- paste your section's repo from the Unit 1 Check-In page --> codepath/pathreview-ai301-fa26-s3
...
I have experience with Java, C#, Python, JavaScript/TypeScript, Git,
REST APIs, and backend development. I am comfortable reading an
existing codebase and making contained changes, but for a first
contribution I would prefer to avoid issues that require deep knowledge
of unfamiliar core internals or major architectural changes. I want to
practice understanding an unfamiliar codebase, tracing existing behavior,
and implementing a meaningful but reasonably bounded change.